...
class LocationDetailSheet extends StatelessWidget {
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Fotos del Edificio (AHORA CON GESTURE DETECTOR PARA AMPLIAR)
            if (location.equipmentImages.isNotEmpty) ...[
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (ctx, i) {
                    final imagePath = location.equipmentImages[i];
                    return GestureDetector(
                      onTap: () => _showFullImageDialog(context, imagePath),
                      child: Container(
                        width: 180,
            ...
            if (location.careers.isNotEmpty) ...[
              ...
              const SizedBox(height: 12),
              ...location.careers.map(
                (career) => _buildCareerSection(context, career),
              ),
            ] else ...[
    ...
    return Container(
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          children: career.labs
              .map((lab) => _buildLabItem(context, lab))
              .toList(),
        ),
      ),
    );
              ...
              child: OutlinedButton.icon(
                onPressed: () {
                  final tempLoc = MapLocation(
                    ...
                    x: 0,
                    y: 0,
                    assetImage360: lab.asset360!,
                  );
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => PanoramaViewer(initialLocation: tempLoc),
                    ),
                  );
                },
  ...
  // ========== NUEVA FUNCIÓN PARA AMPLIAR IMAGEN ==========
