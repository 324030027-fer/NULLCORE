      ...
      children: [
        ...
        Positioned.fill(
          child: GestureDetector(
            onTap: () => mapProvider.selectMapLocation(
              null,
            ), // Tocar mapa cierra el panel
                          ...
                          ...mapProvider.mapPoints.map((loc) {
                            return Positioned(
                              ...
                              child: MapMarker(
                                location: loc,
                                isSelected:
                                    mapProvider.selectedMapLocation?.id ==
                                    loc.id,
        ...
        if (mapProvider.selectedMapLocation != null)
          DraggableScrollableSheet(
            initialChildSize:
                0.8, // Empieza ocupando el 40% de la pantalla (NO TOTALMENTE)
            ...
            builder: (context, scrollController) {
              return LocationDetailSheet(
                ...
                scrollController:
                    scrollController, // Pasamos el controlador para que el scroll funcione al arrastrar
              );
            },
          ),
      ],
